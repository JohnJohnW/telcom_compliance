...
function Home() {
  ...
  const renderComplianceContent = () => {
    let relevantContent = [];
    if (answers?.carrier) {
      relevantContent.push(<Section key="Carrier Licensing and Obligations" title="Carrier Licensing and Obligations" content={content["Carrier Licensing and Obligations"]} />);
    }
    if (answers?.serviceProvider) {
      relevantContent.push(<Section key="Service Provider Rules" title="Service Provider Rules" content={content["Service Provider Rules"]} />);
    }
    if (answers?.international) {
      relevantContent.push(<Section key="International Aspects" title="International Aspects" content={content["International Aspects"]} />);
    }
    if (answers?.emergencyServices) {
      relevantContent.push(<Section key="Emergency Services" title="Emergency Services" content={content["Emergency Services"]} />);
    }
    if (answers?.customerEquipment) {
      relevantContent.push(<Section key="Technical Regulation" title="Technical Regulation" content={content["Technical Regulation"]} />);
    }
    if (answers?.regulatoryFramework) {
      relevantContent.push(<Section key="Regulatory Framework" title="Regulatory Framework" content={content["Regulatory Framework"]} />);
    }
    if (answers?.industryCodes) {
      relevantContent.push(<Section key="Industry Codes and Standards" title="Industry Codes and Standards" content={content["Industry Codes and Standards"]} />);
    }
    if (answers?.protectionOfCommunications) {
      relevantContent.push(<Section key="Protection of Communications" title="Protection of Communications" content={content["Protection of Communications"]} />);
    }
    if (answers?.monitoringAndReporting) {
      relevantContent.push(<Section key="Monitoring and Reporting" title="Monitoring and Reporting" content={content["Monitoring and Reporting"]} />);
    }
    if (answers?.ancillaryMatters) {
      relevantContent.push(<Section key="Ancillary Matters" title="Ancillary Matters" content={content["Ancillary Matters"]} />);
    }
    if (answers?.nationalInterest) {
      relevantContent.push(<Section key="National Interest Matters" title="National Interest Matters" content={content["National Interest Matters"]} />);
    }
    if (answers?.industryAssistance) {
      relevantContent.push(<Section key="Industry Assistance" title="Industry Assistance" content={content["Industry Assistance"]} />);
    }
    if (answers?.standardCarrier) {
      relevantContent.push(<Section key="Standard Carrier Licence Conditions" title="Standard Carrier Licence Conditions" content={content["Standard Carrier Licence Conditions"]} />);
    }
    if (answers?.protectionOfSubmarineCables) {
      relevantContent.push(<Section key="Protection of Submarine Cables" title="Protection of Submarine Cables" content={content["Protection of Submarine Cables"]} />);
    }
  ...
  return (
    <div className="content">
      <h2>Overview</h2>
      <p>{overviewContent}</p>
      <h2>Find your Compliance Obligations</h2>
      <p>Answer the following questions to determine your compliance obligations:</p>
      {!answers ? (
        <CombinedQuestionnaire onSubmit={handleSubmit} />
      ) : (
        <div>
